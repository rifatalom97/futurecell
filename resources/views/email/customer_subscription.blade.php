...
<html>
  <head>
    ...
    <title>{{ isset($user['subject'])?$user['subject']:'Order confirmation' }}</title>
    <style>
		@media only screen and (max-width:620px){
			...
			table.body .article,table.body .wrapper{padding:10px!important}
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Hi {{ isset($user['name'])?$user['name']:'There' }},</p>
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                        @if($user['unsubscribe']==true)
                        You are unsubscribed from our {{ config('app.name') }}. Now you wont get any update from {{ config('app.name') }}
                        @else 
                        You are subscribed to our newsletters. Now you will get notifications and updates about our products and policies
                        @endif
                        </p>
                            ...
                            <tr>
                              <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;" valign="top">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;">
                                  <tbody>
                                    <tr>
                                      <td style="" valign="top" align="center" bgcolor="#3498db">
                                        <a href="{{ url('/store) }}" style="font-family: sans-serif; font-size: 14px; vertical-align: top; border-radius: 5px; text-align: center; background-color: #3498db;padding:5px 10px;color:white;">Our Store</a>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">Sincer</p>
